...
void DeleteButtonDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->deleteClicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DeleteButtonDelegate::*)(const QModelIndex & )>(_a, &DeleteButtonDelegate::deleteClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void DeleteButtonDelegate::deleteClicked(const QModelIndex & _t1)
{
